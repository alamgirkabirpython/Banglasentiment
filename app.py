...
def download_nltk_data():
    try:
        ...
        nltk.download('punkt', download_dir='/home/appuser/nltk_data')  # Ensure the directory is created
...
st.markdown(
    ...
    .dataframe-container {{
        width: 80%;
        margin: 0 auto;
        height: 150px;  /* Fixed height for the DataFrame */
...
# Create horizontal buttons for navigation with unique keys
...
# Manage button clicks using session state
...
if st.session_state["selected_option"] == "Login":
    ...
    st.write("**Address:** Dhaka, Bangladesh")
